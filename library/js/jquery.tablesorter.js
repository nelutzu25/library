...
!(function($) {
	...
	$.extend({
		...
		tablesorter: new function() {
			...
			ts.characterEquivalents = {
				"a" : "\u00e1\u00e0\u00e2\u00e3\u00e4\u0105\u00e5", // A!A AcALA¤Ä…AY
				"A" : "\u00c1\u00c0\u00c2\u00c3\u00c4\u0104\u00c5", // AA€A‚AfA„Ä„A…
				"c" : "\u00e7\u0107\u010d", // A§Ä‡Ä?
				"C" : "\u00c7\u0106\u010c", // A‡Ä†ÄO
				"e" : "\u00e9\u00e8\u00ea\u00eb\u011b\u0119", // A©A¨AaA«Ä›Ä™
				"E" : "\u00c9\u00c8\u00ca\u00cb\u011a\u0118", // A‰A^AŠA‹ÄšÄ~
				"i" : "\u00ed\u00ec\u0130\u00ee\u00ef\u0131", // A­A¬Ä°A®A—Ä±
				"I" : "\u00cd\u00cc\u0130\u00ce\u00cf", // A?AOÄ°AŽA?
				"o" : "\u00f3\u00f2\u00f4\u00f5\u00f6", // A3A2A´AµA¶
				"O" : "\u00d3\u00d2\u00d4\u00d5\u00d6", // A“A’A”A•A–
				"ss": "\u00df", // AY (s sharp)
				"SS": "\u1e9e", // áož (Capital sharp s)
				"u" : "\u00fa\u00f9\u00fb\u00fc\u016f", // AoA1A»A1A—
				"U" : "\u00da\u00d9\u00db\u00dc\u016e" // AšA™A›AoA®
			};
	...
	ts.addParser({
		id: "currency",
		is: function(s) {
			return (/^\(?\d+[\u00a3$\u20ac\u00a4\u00a5\u00a2?.]|[\u00a3$\u20ac\u00a4\u00a5\u00a2?.]\d+\)?$/).test((s || '').replace(/[+\-,. ]/g,'')); // ÂL$â‚¬Â¤ÂYÂc
		},
		format: function(s, table) {
			var n = ts.formatFloat((s || '').replace(/[^\w,. \-()]/g, ""), table);
			return s && typeof n === 'number' ? n : s ? $.trim( s && table.config.ignoreCase ? s.toLocaleLowerCase() : s ) : s;
